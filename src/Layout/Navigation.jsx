    ...
    return (
        <div className="navigation">
            <Nav variant="tabs" defaultActiveKey="/">
                ...
                <Nav.Item>
                    <NavLink className="NavLink nav-link" activeclassname="nav-link--active" to="/profile" eventKey="link-2">
                        <b></b>
                        <b></b>
                ...
                <Nav.Item>
                    <NavLink className="NavLink nav-link" activeclassname="nav-link--active" to="/schedule" eventKey="link-3">
                        <b></b>
                        <b></b>
                ...
                <Nav.Item>
                    <NavLink className="NavLink nav-link" activeclassname="nav-link--active" to="/activities" eventKey="link-4">
                        <b></b>
                        <b></b>
                ...
                <Nav.Item>
                    <NavLink className="NavLink nav-link" activeclassname="nav-link--active" to="/settings" eventKey="link-5">
                        <b></b>
                        <b></b>
